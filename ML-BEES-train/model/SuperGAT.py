# ------------------------------------------------------------------
# Self-supervised Graph Attention Networks (https://openreview.net/forum?id=Wi5KUNlqWty)
# ------------------------------------------------------------------
...
class SuperGAT(nn.Module):
    """
         Self-supervised Graph Attention network for EC-Land dataset
    """
    ...
    def __init__(
        ...
        self.conv1 = SuperGATConv(input_dim, hidden_dim, heads=1)
        self.conv2 = SuperGATConv(hidden_dim, hidden_dim, heads=1)
        self.conv3 = SuperGATConv(hidden_dim, hidden_dim, heads=1)
        self.conv4 = SuperGATConv(hidden_dim, hidden_dim, heads=1)
        self.conv5 = SuperGATConv(hidden_dim, hidden_dim, heads=1)
