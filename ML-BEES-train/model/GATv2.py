...
class GATv2(nn.Module):
    """
        Graph Attention Networks V2 model for EC-Land dataset
    """
    ...
    def __init__(
        ...
        self.conv1 = GATv2Conv(input_dim, hidden_dim, heads=1)
        self.conv2 = GATv2Conv(hidden_dim, hidden_dim, heads=1)
        self.conv3 = GATv2Conv(hidden_dim, hidden_dim, heads=1)
        self.conv4 = GATv2Conv(hidden_dim, hidden_dim, heads=1)
        self.conv5 = GATv2Conv(hidden_dim, hidden_dim, heads=1)
