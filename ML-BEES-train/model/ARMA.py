# ------------------------------------------------------------------
# Graph Neural Networks with auto-regressive moving average (ARMA) filters (https://arxiv.org/abs/1901.01343)
# ------------------------------------------------------------------
...
class ARMA(nn.Module):
    """
        Graph Neural Networks with auto-regressive moving average (ARMA) filters for EC-Land dataset
    """
    ...
    def __init__(
        ...
        self.conv2 = ARMAConv(hidden_dim, hidden_dim)
        self.conv3 = ARMAConv(hidden_dim, hidden_dim)
        self.conv4 = ARMAConv(hidden_dim, hidden_dim)
        self.conv5 = ARMAConv(hidden_dim, hidden_dim)
