# ------------------------------------------------------------------
# Unified Message Passing Model (https://arxiv.org/abs/2009.03509)
# ------------------------------------------------------------------
...
class UniMP(nn.Module):
    """
        Unified Message Passing model for EC-Land dataset
    """
    ...
    def __init__(
        ...
        self.conv2 = TransformerConv(hidden_dim, hidden_dim, heads=1)
        self.conv3 = TransformerConv(hidden_dim, hidden_dim, heads=1)
        self.conv4 = TransformerConv(hidden_dim, hidden_dim, heads=1)
        self.conv5 = TransformerConv(hidden_dim, hidden_dim, heads=1)
